...
proto.visitCheckboxItems = require('./macro/checkbox-items')
...
proto.visitors = {
  ...
  inlineMath: require('./visitors/inline-math'),
  math: require('./visitors/math'),
  ...
  details: require('./visitors/details'),
